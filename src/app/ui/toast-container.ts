    ...
    <div class="fixed bottom-4 right-4 z-[1000] space-y-3 pointer-events-none">
      @for (t of toastService.toasts(); track t.id) {
        <div
          role="status"
          aria-live="polite"
          class="pointer-events-auto flex w-80 items-center rounded-lg p-4 shadow bg-white dark:bg-gray-800 border"
        ...
        >
          ...
          <div class="text-sm text-gray-800 dark:text-gray-100 flex-1">{{ t.message }}</div>
