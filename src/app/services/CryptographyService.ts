...
import {byteToBin, fixMojibake, hexToBase64Url} from '../util/strings.util';
...
export class CryptographyService {
  ...
  async decrypt(file: File, password: string) {
    ...
    const certInfo = this.buildCertificateInfo(leaf);
    ...
    return {
      ...
      certInfo: this.buildCertificateInfo(leaf)
    }
  }
  ...
  #buildJwk(pksc1: forge.pki.rsa.PrivateKey, chain?: forge.pki.Certificate[]) {
    return {
      kty: 'RSA',
